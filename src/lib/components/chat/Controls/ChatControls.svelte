<script context="module" lang="ts">
	let savedTab: 'studio' | 'controls' | 'files' | 'overview' = 'studio';
</script>
...
<script lang="ts">
	...
	$: if (!showStudioTab && !showControlsTab && !showFilesTab && !showOverviewTab) {
			...
			<div class="h-[100dvh] flex flex-col">
				...
				{:else}
					...
					<div class="flex flex-col h-full min-h-0">
						...
						<div
                            class="flex-1 min-h-0 {activeTab === 'overview' || activeTab === 'studio'
                                ? 'h-full'
                                : activeTab === 'controls'
                        ...
                        >
                            {#if activeTab === 'studio'}
                                <div class="h-full w-full bg-black overflow-hidden relative">
                                    <Canvas />
                                </div>
